    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= base_url().'cms-admin/admin' ?>">Dashboard | NEXTCMS</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?php echo base_url().'assets/resource/admin/';?>images/user.png" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $this->session->userdata('fullname') ?></div>
                    <div class="email"><?= $this->session->userdata('email') ?></div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?= base_url().'cms-admin/logout' ?>"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?= ($menuactive == 'users' ? 'active':'' ) ?>">
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?= base_url().'cms-admin/users' ?>">List</a>
                            </li>
                            <li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; <?= date('Y') ?> <a href="javascript:void(0);">NextCMS</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>

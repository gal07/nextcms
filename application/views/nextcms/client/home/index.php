...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/resource/client/';?>css/bootstrap.min.css" media="screen">	
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/resource/client/';?>css/jquery.bxslider.css" media="screen">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/resource/client/';?>css/font-awesome.css" media="screen">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/resource/client/';?>css/magnific-popup.css" media="screen">	
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/resource/client/';?>css/owl.carousel.css" media="screen">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/resource/client/';?>css/owl.theme.css" media="screen">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/resource/client/';?>css/ticker-style.css"/>
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/resource/client/';?>css/style.css" media="screen">
...
<body>
														...
														<div class="owl-carousel" data-num="4">
															...
															<div class="item news-post standard-post">
																<div class="post-gallery">
																	<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/art1.jpg" alt="">
																</div>
															...
															<div class="item news-post standard-post">
																<div class="post-gallery">
																	<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/art2.jpg" alt="">
																</div>
																<div class="post-content">
															...
															<div class="item news-post standard-post">
																<div class="post-gallery">
																	<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/art3.jpg" alt="">
																</div>
																<div class="post-content">
															...
															<div class="item news-post standard-post">
																<div class="post-gallery">
																	<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/art6.jpg" alt="">
																</div>
																<div class="post-content">
															...
															<div class="item news-post standard-post">
																<div class="post-gallery">
																	<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/art9.jpg" alt="">
																</div>
																<div class="post-content">
																	<h2><a href="single-post.html">Donec nec justo eget felis facilisis fermentum. </a></h2>
																	<ul class="post-tags">
												...
												<div class="owl-wrapper">
													...
													<div class="owl-carousel" data-num="4">
														...
														<div class="item news-post video-post">
															<img alt="" src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/video1.jpg">
														...
														<div class="item news-post video-post">
															<img alt="" src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/video2.jpg">
															<a href="https://www.youtube.com/watch?v=LL59es7iy8Q" class="video-link"><i class="fa fa-play-circle-o"></i></a>
															<div class="hover-box">
														...
														<div class="item news-post video-post">
															<img alt="" src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/video3.jpg">
															<a href="https://www.youtube.com/watch?v=LL59es7iy8Q" class="video-link"><i class="fa fa-play-circle-o"></i></a>
															<div class="hover-box">
														...
														<div class="item news-post video-post">
															<img alt="" src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/video4.jpg">
															<a href="https://www.youtube.com/watch?v=LL59es7iy8Q" class="video-link"><i class="fa fa-play-circle-o"></i></a>
															<div class="hover-box">
																<h2><a href="single-post.html">Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</a></h2>
																<ul class="post-tags">
		...
		<section class="heading-news">
			...
			<div class="iso-call heading-news-box">
				...
				<div class="news-post image-post default-size">
					<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/h1.jpg" alt="">
					<div class="hover-box">
					...
					<ul class="bxslider">
						<li>
							<div class="news-post image-post">
								<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/h2.jpg" alt="">
								<div class="hover-box">
									<div class="inner-hover">
						...
						<li>
							<div class="news-post image-post">
								<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/h7.jpg" alt="">
								<div class="hover-box">
									<div class="inner-hover">
						...
						<li>
							<div class="news-post image-post">
								<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/h4.jpg" alt="">
								<div class="hover-box">
									<div class="inner-hover">
										<a class="category-post sport" href="sport.html">sport</a>
										<h2><a href="single-post.html">Donec odio. Quisque volutpat mattis eros. </a></h2>
				...
				<div class="news-post image-post">
					<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/h3.jpg" alt="">
					<div class="hover-box">
						<div class="inner-hover">
				...
				<div class="news-post image-post">
					<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/h5.jpg" alt="">
					<div class="hover-box">
						<div class="inner-hover">
							<a class="category-post sport" href="sport.html">sport</a>
				...
				<div class="news-post image-post">
					<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/h6.jpg" alt="">
					<div class="hover-box">
						<div class="inner-hover">
			...
			<div class="container">
				...
				<div class="features-today-box owl-wrapper">
					<div class="owl-carousel" data-num="4">
						...
						<div class="item news-post standard-post">
							<div class="post-gallery">
								<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/st1.jpg" alt="">
						...
						<div class="item news-post standard-post">
							<div class="post-gallery">
								<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/st2.jpg" alt="">
								<a class="category-post sport" href="sport.html">Sport</a>
							</div>
							<div class="post-content">
								<h2><a href="single-post.html">Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</a></h2>
						...
						<div class="item news-post standard-post">
							<div class="post-gallery">
								<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/st3.jpg" alt="">
								<a class="category-post food" href="food.html">Food &amp; Health</a>
							</div>
							<div class="post-content">
						...
						<div class="item news-post standard-post">
							<div class="post-gallery">
								<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/st4.jpg" alt="">
								<a class="category-post sport" href="sport.html">Sport</a>
							</div>
							<div class="post-content">
								...
								<div class="owl-carousel" data-num="2">
									...
									<div class="item">
										<div class="news-post image-post2">
											<div class="post-gallery">
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/im1.jpg" alt="">
												<div class="hover-box">
													<div class="inner-hover">
														<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
														<ul class="post-tags">
										...
										<ul class="list-posts">
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/list1.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/list2.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/list3.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
									...
									<div class="item">
										<div class="news-post image-post2">
											<div class="post-gallery">
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/im2.jpg" alt="">
												<div class="hover-box">
													<div class="inner-hover">
														<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
														<ul class="post-tags">
										...
										<ul class="list-posts">
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/list4.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/list5.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/list6.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
									...
									<div class="item">
										<div class="news-post image-post2">
											<div class="post-gallery">
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/im3.jpg" alt="">
												<div class="hover-box">
													<div class="inner-hover">
														<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
														<ul class="post-tags">
										...
										<ul class="list-posts">
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/list7.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/list8.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/list9.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
										...
										<div class="image-post-slider">
											<ul class="bxslider">
												...
												<li>
													<div class="news-post image-post2">
														<div class="post-gallery">
															<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/im4.jpg" alt="">
															<div class="hover-box">
																<div class="inner-hover">
																	<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
																	<ul class="post-tags">
							...
							<div class="masonry-box">
								...
								<div class="latest-articles iso-call">
									...
									<div class="news-post standard-post2 default-size">
										<div class="post-gallery">
											<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/1.jpg" alt="">
										</div>
									...
									<div class="news-post standard-post2">
										<div class="post-gallery">
											<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/2.jpg" alt="">
										</div>
										<div class="post-title">
											<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
											<ul class="post-tags">
									...
									<div class="news-post standard-post2">
										<div class="post-gallery">
											<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/3.jpg" alt="">
										</div>
										<div class="post-title">
											<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
											<ul class="post-tags">
									...
									<div class="news-post standard-post2">
										<div class="post-gallery">
											<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/4.jpg" alt="">
										</div>
										<div class="post-title">
											<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
											<ul class="post-tags">
									...
									<div class="news-post standard-post2">
										<div class="post-gallery">
											<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/5.jpg" alt="">
										</div>
										<div class="post-title">
											<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
											<ul class="post-tags">
									...
									<div class="news-post standard-post2">
										<div class="post-gallery">
											<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/6.jpg" alt="">
										</div>
										<div class="post-title">
											<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
											<ul class="post-tags">
							...
							<div class="widget tab-posts-widget">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="option1">
										<ul class="list-posts">
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/listw1.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/listw2.jpg" alt="">
												<div class="post-content">
											...
											<li>
												<img src="<?php echo base_url().'assets/resource/client/';?>upload/news-posts/listw3.jpg" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Phasellus ultrices nulla quis nibh. Quisque a lectus.  </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
						...
						<div class="col-md-3">
							<div class="widget flickr-widget">
								...
								<ul class="flickr-list">
									<li><a href="#"><img src="<?php echo base_url().'assets/resource/client/';?>upload/flickr/1.jpg" alt=""></a></li>
									<li><a href="#"><img src="<?php echo base_url().'assets/resource/client/';?>upload/flickr/2.jpg" alt=""></a></li>
									<li><a href="#"><img src="<?php echo base_url().'assets/resource/client/';?>upload/flickr/3.jpg" alt=""></a></li>
									<li><a href="#"><img src="<?php echo base_url().'assets/resource/client/';?>upload/flickr/4.jpg" alt=""></a></li>
									<li><a href="#"><img src="<?php echo base_url().'assets/resource/client/';?>upload/flickr/5.jpg" alt=""></a></li>
									<li><a href="#"><img src="<?php echo base_url().'assets/resource/client/';?>upload/flickr/6.jpg" alt=""></a></li>
								</ul>
	...
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/jquery.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/jquery.migrate.js"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/jquery.bxslider.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/jquery.magnific-popup.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/bootstrap.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/jquery.ticker.js"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/jquery.imagesloaded.min.js"></script>
  	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/jquery.isotope.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/owl.carousel.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/retina-1.1.0.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/resource/client/';?>js/script.js"></script>
